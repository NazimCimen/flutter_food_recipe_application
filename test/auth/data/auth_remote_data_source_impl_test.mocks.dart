...
// in flutter_food_recipe_application/test/auth/data/auth_remote_data_source_impl_test.dart.
...
class MockINetworkInfo extends _i1.Mock implements _i4.INetworkInfo {
  ...
  @override
  _i5.Future<_i4.ConnectivityResult> get getConnectionType =>
      (super.noSuchMethod(
        Invocation.getter(#getConnectionType),
        returnValue: _i5.Future<_i4.ConnectivityResult>.value(
            _i4.ConnectivityResult.bluetooth),
      ) as _i5.Future<_i4.ConnectivityResult>);
...
/// A class which mocks [IErrorMapper].
///
/// See the documentation for Mockito's code generation for more information.
class MockIErrorMapper extends _i1.Mock implements _i4.IErrorMapper {
  MockIErrorMapper() {
    _i1.throwOnMissingStub(this);
  }
  ...
  String mapFirebaseAuthExceptionToMessage(String? firebaseAuthExceptionCode) =>
      (super.noSuchMethod(
        Invocation.method(
          #mapFirebaseAuthExceptionToMessage,
